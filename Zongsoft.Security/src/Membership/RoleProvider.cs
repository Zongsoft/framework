...
{
	[Service(typeof(IRoleProvider<IRoleModel>))]
	public class RoleProvider : RoleProviderBase<IRoleModel>
	{
		#region 构造函数
		...
		#region 重写方法
		protected override IRoleModel CreateRole()
		{
			return Model.Build<IRoleModel>();
		}
