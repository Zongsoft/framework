...
本交互式范例演示 `Zongsoft.Messaging.Kafka` 的队列、消息发布、订阅和消息确认 API。

项目面向 .NET 10，默认连接 `127.0.0.1:9092` 的 Kafka 代理。如果代理使用不同端点或身份认证设置，请修改 `Program.cs` 中的连接参数。
