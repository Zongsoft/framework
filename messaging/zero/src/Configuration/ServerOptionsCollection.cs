...
public sealed class ServerOptionsCollection() : KeyedCollection<string, ServerOptions>(StringComparer.OrdinalIgnoreCase)
{
	public ServerOptions.ServerPort Port { get; set; }
	protected override string GetKeyForItem(ServerOptions item) => item.Name;
}
