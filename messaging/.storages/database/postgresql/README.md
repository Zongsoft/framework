...
Indexes support namespace-wide and namespace/topic expiry scans. Quoted mixed-case identifiers are intentional; preserve them in manual queries and migrations.
...
For backup and high availability, follow the [PostgreSQL documentation](https://www.postgresql.org/docs/). The parent [storage guide](../../README.md) explains partition identifiers and connection resolution.
