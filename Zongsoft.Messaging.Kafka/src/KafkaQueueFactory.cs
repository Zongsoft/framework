...
public sealed class KafkaQueueFactory() : MessageQueueFactoryBase(NAME)
{
	internal const string NAME = "Kafka";
	public override IMessageQueue Create(IConnectionSettings settings) => new KafkaQueue(string.Empty, settings);
}
