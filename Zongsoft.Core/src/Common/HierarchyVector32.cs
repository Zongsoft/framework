...
namespace Zongsoft.Common
{
	...
	public readonly struct HierarchyVector32 : IEquatable<HierarchyVector32>, IEquatable<uint>
	{
		...
		public static readonly HierarchyVector32 Zero = new HierarchyVector32(0);
		#endregion
		...
		#region 公共属性
		public bool IsZero { get=> this.Value == 0; }
		#endregion
		...
		{
			if(value == 0)
				return include ? new uint[] { 0u } : Array.Empty<uint>();
			...
			if((value & 0x00_00_FF_00) > 0)
			{
				...
				return include ? new uint[] { 0u, value } : new uint[] { 0u };
			...
			{
				1 => include ? new uint[] { 0u, ancestor1, value } : new uint[] { 0u, ancestor1 },
				2 => include ? new uint[] { 0u, ancestor1, ancestor2, value } : new uint[] { 0u, ancestor1, ancestor2 },
				3 => include ? new uint[] { 0u, ancestor1, ancestor2, ancestor3, value } : new uint[] { 0u, ancestor1, ancestor2, ancestor3 },
				_ => include ? new uint[] { 0u, value } : new uint[] { 0u },
			};
		}
		#endregion
