...
namespace Zongsoft.Services.Commands
{
	...
	public class WorkerStopCommand : CommandBase<CommandContext>
	{
		...
		{
			output.WriteLine(Utility.GetWorkerActionContent(worker, string.Format(Properties.Resources.Text_Command_ExecutionFailed_Message, Properties.Resources.Text_WorkerStopCommand_Name), CommandOutletColor.DarkRed));
		}
