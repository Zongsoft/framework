...
public abstract class CommandBase<TContext> : CommandBase, ICommand<TContext>, Common.IPredication<TContext> where TContext : CommandContext
{
	#region 构造函数
	...
	/// </remarks>
	public object Execute(TContext context) => base.Execute(context);
	#endregion
	...
	bool Common.IPredication<TContext>.Predicate(TContext context) => this.CanExecute(context);
	#endregion
}
