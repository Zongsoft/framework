...
namespace Zongsoft.Data
{
	...
	public class ConditionalAttribute : Attribute
	{
		...
		public ConditionalAttribute(bool ignored)
		{
			...
			this.Behaviors = ConditionalBehaviors.IgnoreNullOrEmpty;
		}
		...
		public Type ConverterType
		{
			...
			set
			{
				if(value != null && !typeof(IConditionalConverter).IsAssignableFrom(value))
					throw new ArgumentException($"The specified '{value}' type is not an unimplemented '{typeof(IConditionalConverter)}' interface.");
