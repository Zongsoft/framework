...
partial class DataServiceBase<TModel>
{
	...
	public ValueTask<int> UpdateManyAsync(IEnumerable items, DataUpdateOptions options = null, CancellationToken cancellation = default) => this.UpdateManyAsync(items, string.Empty, options, cancellation);
	public ValueTask<int> UpdateManyAsync(IEnumerable items, string schema, DataUpdateOptions options = null, CancellationToken cancellation = default)
	{
		//确认是否可以执行该操作
		this.EnsureUpdate(options);
	...
	public ValueTask<int> UpdateManyAsync(string key, IEnumerable items, DataUpdateOptions options = null, CancellationToken cancellation = default) => this.UpdateManyAsync(key, items, null, options, cancellation);
	public ValueTask<int> UpdateManyAsync(string key, IEnumerable items, string schema, DataUpdateOptions options = null, CancellationToken cancellation = default)
	{
		//确认是否可以执行该操作
		this.EnsureUpdate(options);
	...
	protected virtual ValueTask<int> OnUpdateManyAsync(IEnumerable<IDataDictionary<TModel>> items, ISchema schema, DataUpdateOptions options, CancellationToken cancellation)
	{
		if(items == null)
			return ValueTask.FromResult(0);
