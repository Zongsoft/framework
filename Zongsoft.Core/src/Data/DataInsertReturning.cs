...
public sealed class DataInsertReturning : IDictionary<string, object>
{
	#region 成员字段
	...
	#region 构造函数
	public DataInsertReturning(params string[] names) => _dictionary = names == null ?
	...
	public DataInsertReturning(IEnumerable<string> names) => _dictionary = names == null ?
		new Dictionary<string, object>(StringComparer.OrdinalIgnoreCase) :
		new Dictionary<string, object>(names.Select(name => new KeyValuePair<string, object>(name, null)), StringComparer.OrdinalIgnoreCase);
	#endregion
