...
public class DataImportOptions : DataOptionsBase, IDataImportOptions
{
	...
	/// <inheritdoc />
	public bool TransactionSuppressed { get; set; }
	#endregion
	...
	/// <summary>创建一个禁用关联环境事务的导入选项构建器。</summary>
	/// <returns>返回创建的<see cref="Builder"/>构建器对象。</returns>
	public static Builder SuppressTransaction() => new(null) { TransactionSuppressed = true };
	...
	public class Builder : DataOptionsBuilder<DataImportOptions>
	{
		...
		public Builder SuppressTransaction() { this.TransactionSuppressed = true; return this; }
		public Builder UnsuppressTransaction() { this.TransactionSuppressed = false; return this; }
		#endregion
		...
		public override DataImportOptions Build() => new DataImportOptions(this.Parameters)
		{
			...
			TransactionSuppressed = this.TransactionSuppressed,
		};
		#endregion
