...
public class Condition : ICondition, IEquatable<Condition>
{
	...
	#region 静态方法
	/// <summary>创建一个用于相等比较的过滤条件设置项。</summary>
	...
	/// <summary>创建一个用于不相等比较的过滤条件设置项。</summary>
	/// <param name="name">字段名。</param>
	/// <param name="value">字段值。</param>
	/// <returns>返回构建成功的条件项。</returns>
	...
	/// <summary>创建一个用于大于比较的过滤条件设置项。</summary>
	/// <param name="name">字段名。</param>
	/// <param name="value">字段值。</param>
	/// <returns>返回构建成功的条件项。</returns>
	...
	/// <summary>创建一个用于大于等于比较的过滤条件设置项。</summary>
	/// <param name="name">字段名。</param>
	/// <param name="value">字段值。</param>
	/// <returns>返回构建成功的条件项。</returns>
	...
	/// <summary>创建一个用于小于比较的过滤条件的设置项。</summary>
	/// <param name="name">字段名。</param>
	/// <param name="value">字段值。</param>
	/// <returns>返回构建成功的条件项。</returns>
	...
	/// <summary>创建一个用于小于等于比较的过滤条件的设置项。</summary>
	/// <param name="name">字段名。</param>
	/// <param name="value">字段值。</param>
	/// <returns>返回构建成功的条件项。</returns>
	...
	/// <summary>创建一个用于模糊匹配的过滤条件的设置项。</summary>
	/// <param name="name">字段名。</param>
	/// <param name="value">字段值。</param>
	/// <returns>返回构建成功的条件项。</returns>
	...
	/// <summary>创建一个用于范围匹配的过滤条件的设置项。</summary>
	...
	/// <summary>创建一个用于匹配多个值的过滤条件的设置项。</summary>
	...
	/// <summary>创建一个用于排除多个值的过滤条件的设置项。</summary>
	...
	/// <summary>创建一个用于表示存在于子查询结果的过滤条件的设置项。</summary>
	/// <param name="name">字段名。</param>
	...
	/// <summary>创建一个用于表示不存在于子查询结果的过滤条件的设置项。</summary>
	/// <param name="name">字段名。</param>
	/// <param name="filter">子查询的过滤条件。</param>
	/// <returns>返回构建成功的条件项。</returns>
