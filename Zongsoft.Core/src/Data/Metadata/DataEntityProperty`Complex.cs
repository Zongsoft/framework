...
public class DataEntityComplexProperty : DataEntityPropertyBase, IDataEntityComplexProperty
{
	...
	public DataEntityComplexProperty(string name, string port, bool immutable, DataEntityComplexPropertyBehaviors behaviors, DataAssociationMultiplicity multiplicity, params DataAssociationLink[] links) : this(null, name, port, immutable, behaviors, multiplicity, links) { }
