...
namespace Zongsoft.Caching
{
	...
	public class MemoryCacheEx
	{
		...
		#region 过期回调
		private void OnExpired(string key, object value) => this.OnChanged(CacheChangedEventArgs.Expired(key, value));
		#endregion

		#region 激发事件
		protected virtual void OnChanged(CacheChangedEventArgs args) => this.Changed?.Invoke(this, args);
		#endregion
