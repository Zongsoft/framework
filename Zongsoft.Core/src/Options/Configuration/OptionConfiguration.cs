...
namespace Zongsoft.Options.Configuration
{
	...
	public class OptionConfiguration : IOptionProvider
	{
		...
		private readonly OptionConfigurationSectionCollection _sections;
		#endregion
		...
		public object GetOptionValue(string text)
		{
			...
			OptionUtility.ResolveOptionPath(expression.Path, out string sectionPath, out string elementName);
