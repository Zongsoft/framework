...
partial class LoggingBase<TLog>
{
	...
	public void Fatal(object source, Exception exception, object data = null, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.Log(this.CreateLog(LogLevel.Fatal, exception, data, this.GetSource(source?.GetType()), action));
	public void Fatal(object source, string message, object data = null, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.Log(this.CreateLog(LogLevel.Fatal, message, data, this.GetSource(source?.GetType()), action));
	public void Fatal(object source, string message, Exception exception, object data = null, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.Log(this.CreateLog(LogLevel.Fatal, message, exception, data, this.GetSource(source?.GetType()), action));
	...
	public ValueTask FatalAsync(object source, Exception exception, CancellationToken cancellation = default, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.LogAsync(this.CreateLog(LogLevel.Fatal, exception, null, this.GetSource(source?.GetType()), action), cancellation);
	public ValueTask FatalAsync(object source, Exception exception, object data, CancellationToken cancellation = default, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.LogAsync(this.CreateLog(LogLevel.Fatal, exception, data, this.GetSource(source?.GetType()), action), cancellation);
	public ValueTask FatalAsync(object source, string message, CancellationToken cancellation = default, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.LogAsync(this.CreateLog(LogLevel.Fatal, message, null, this.GetSource(source?.GetType()), action), cancellation);
	public ValueTask FatalAsync(object source, string message, object data, CancellationToken cancellation = default, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.LogAsync(this.CreateLog(LogLevel.Fatal, message, data, this.GetSource(source?.GetType()), action), cancellation);
	public ValueTask FatalAsync(object source, string message, Exception exception, CancellationToken cancellation = default, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.LogAsync(this.CreateLog(LogLevel.Fatal, message, exception, null, this.GetSource(source?.GetType()), action), cancellation);
	public ValueTask FatalAsync(object source, string message, Exception exception, object data, CancellationToken cancellation = default, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.LogAsync(this.CreateLog(LogLevel.Fatal, message, exception, data, this.GetSource(source?.GetType()), action), cancellation);
}
