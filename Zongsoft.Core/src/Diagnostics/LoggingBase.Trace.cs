...
partial class LoggingBase<TLog>
{
	...
	public void Trace(object source, Exception exception, object data = null, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.Log(this.CreateLog(LogLevel.Trace, exception, data, this.GetSource(source?.GetType()), action));
	public void Trace(object source, string message, object data = null, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.Log(this.CreateLog(LogLevel.Trace, message, data, this.GetSource(source?.GetType()), action));
	public void Trace(object source, string message, Exception exception, object data = null, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.Log(this.CreateLog(LogLevel.Trace, message, exception, data, this.GetSource(source?.GetType()), action));
	...
	public ValueTask TraceAsync(object source, Exception exception, CancellationToken cancellation = default, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.LogAsync(this.CreateLog(LogLevel.Trace, exception, null, this.GetSource(source?.GetType()), action), cancellation);
	public ValueTask TraceAsync(object source, Exception exception, object data, CancellationToken cancellation = default, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.LogAsync(this.CreateLog(LogLevel.Trace, exception, data, this.GetSource(source?.GetType()), action), cancellation);
	public ValueTask TraceAsync(object source, string message, CancellationToken cancellation = default, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.LogAsync(this.CreateLog(LogLevel.Trace, message, null, this.GetSource(source?.GetType()), action), cancellation);
	public ValueTask TraceAsync(object source, string message, object data, CancellationToken cancellation = default, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.LogAsync(this.CreateLog(LogLevel.Trace, message, data, this.GetSource(source?.GetType()), action), cancellation);
	public ValueTask TraceAsync(object source, string message, Exception exception, CancellationToken cancellation = default, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.LogAsync(this.CreateLog(LogLevel.Trace, message, exception, null, this.GetSource(source?.GetType()), action), cancellation);
	public ValueTask TraceAsync(object source, string message, Exception exception, object data, CancellationToken cancellation = default, [System.Runtime.CompilerServices.CallerMemberName] string action = null) => Logging.LogAsync(this.CreateLog(LogLevel.Trace, message, exception, data, this.GetSource(source?.GetType()), action), cancellation);
}
