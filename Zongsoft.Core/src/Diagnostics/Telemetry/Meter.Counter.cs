...
{
	private static readonly MethodInfo _CounterMethod_ = typeof(Meter).GetMethod(
	...
	public static Instrument CreateCounter(this Meter meter, string name, Type type, string unit = null, string description = null)
	{
		if(meter == null)
	...
	public static Instrument CreateCounter(this Meter meter, string name, Type type, string unit, IEnumerable<KeyValuePair<string, object>> tags = null) => CreateCounter(meter, name, type, unit, null, tags);
	public static Instrument CreateCounter(this Meter meter, string name, Type type, string unit, string description, IEnumerable<KeyValuePair<string, object>> tags = null)
	{
		if(meter == null)
			throw new ArgumentNullException(nameof(meter));
		if(string.IsNullOrWhiteSpace(name))
