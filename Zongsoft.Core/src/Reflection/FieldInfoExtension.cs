...
public static class FieldInfoExtension
{
	...
	#region 缓存变量
	private static readonly ConcurrentDictionary<FieldInfo, FieldToken> _fields = new();
	private static readonly ConcurrentDictionary<FieldKey, FieldTokenGeneric> _genericProperties = new();
	#endregion
	...
	#region 嵌套子类
	private readonly struct FieldKey(Type type, FieldInfo field) : IEquatable<FieldKey>
	{
	...
	private class FieldToken(Getter getter, Setter setter)
	{
		public readonly Getter Getter = getter;
		public readonly Setter Setter = setter;
	}

	private readonly struct FieldTokenGeneric(Delegate getter, Delegate setter)
	{
