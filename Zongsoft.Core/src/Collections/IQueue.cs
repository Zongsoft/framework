...
namespace Zongsoft.Collections
{
	...
	public interface IQueue : ICollection
	{
		...
		#region 默认实现
		Task EnqueueAsync(object item, CancellationToken cancellation)
		{
			return this.EnqueueAsync(item, null, cancellation);
		}

		Task EnqueueManyAsync<T>(IEnumerable<T> items, CancellationToken cancellation)
		{
			return this.EnqueueManyAsync(items, null, cancellation);
		}
		#endregion
	}
}
