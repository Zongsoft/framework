...
{
	#region 构造函数
	public AuthenticatedEventArgs(ClaimsPrincipal principal, string scenario, Parameters parameters = null)
	{
...
{
	#region 构造函数
	public AuthenticatingEventArgs(object ticket, string scenario, Parameters parameters = null)
	{
		this.Ticket = ticket;
		this.Scenario = scenario;
		this.Parameters = parameters;
