...
namespace Zongsoft.Data.Tests
{
	public class ModelTest
	{
		...
		public void TestEmployee()
		{
			...
			this.TestEmployeeCore(employee);
		}
		...
		public void TestCustomer()
		{
			...
			this.TestCustomerCore(customer);
		}
		...
		public void TestSpecialEmployee()
		{
			...
			this.TestSpecialEmployeeCore(special);
		}
		#endregion

		#region 私有方法
		private void TestPersonCore(Zongsoft.Tests.IPerson person)
		{
			if(person == null)
		...
		private void TestEmployeeCore(Zongsoft.Tests.IEmployee employee)
		{
			object value;
			IDictionary<string, object> changes;

			// Test the IPerson interface.
			this.TestPersonCore(employee);
		...
		private void TestCustomerCore(Zongsoft.Tests.ICustomer customer)
		{
			object value;
			IDictionary<string, object> changes;

			// Test the IPerson interface.
			this.TestPersonCore(customer);
		...
		private void TestSpecialEmployeeCore(Zongsoft.Tests.ISpecialEmployee employee)
		{
			object value;
			IDictionary<string, object> changes;
