...
public class Report : IReport, IDisposable
{
	...
	public GrapeCity.ActiveReports.PageReportModel.Report AsReport() => _report.Report;
	...
	public void ExportToFile(string filePath, IReportExportOptions options) => this.Export(FileSystem.File.Open(filePath, FileMode.OpenOrCreate, FileAccess.Write), options);

	public void Render(Stream stream, IReportRenderOptions options) => throw new NotImplementedException();
	public void RenderToFile(string filePath, IReportRenderOptions options) => throw new NotImplementedException();
	#endregion
