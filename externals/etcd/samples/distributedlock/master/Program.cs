...
using var etcd = new EtcdService("master", connectionString) { Namespace = "samples:distributed-lock" };
...
for(var index = 0; index < 10; index++)
{
	...
	Console.WriteLine($"MASTER fence={locker.FencingToken}, counter={value}");
