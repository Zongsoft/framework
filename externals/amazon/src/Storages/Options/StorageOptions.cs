...
namespace Zongsoft.Externals.Amazon.Storages.Options;
...
public class StorageOptionsCollection() : KeyedCollection<string, StorageOptions>(StringComparer.OrdinalIgnoreCase)
{
	public string Default { get; set; }
	public bool TryGetDefault(out StorageOptions result)
	{
	...
	public StorageOptions GetDefault()
	{
		if(string.IsNullOrEmpty(this.Default))
			return this[0];
	...
	protected override string GetKeyForItem(StorageOptions storage) => storage.Region ?? string.Empty;
}