...
namespace Zongsoft.Externals.ClosedXml.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   查找类似 Unsupported rendering format: &apos;{0}&apos;. 的本地化字符串。
        /// </summary>
        internal static string Spreadsheet_RenderingFormatUnsupported_Message {
            get {
                return ResourceManager.GetString("Spreadsheet.RenderingFormatUnsupported.Message", resourceCulture);
            }
        }

        /// <summary>
        ///   查找类似 Unsupported template format: &apos;{0}&apos;. 的本地化字符串。
        /// </summary>
        internal static string Spreadsheet_TemplateFormatUnsupported_Message {
            get {
                return ResourceManager.GetString("Spreadsheet.TemplateFormatUnsupported.Message", resourceCulture);
            }
        }
