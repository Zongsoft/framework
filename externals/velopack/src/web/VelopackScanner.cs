...
public class VelopackScanner
{
	const string RELEASES_DIRECTORY = "releases";

	public IEnumerable<VelopackAsset> Scan(string path)
	{
		if(string.IsNullOrEmpty(path))
			path = Path.Combine(ApplicationContext.Current.ApplicationPath, RELEASES_DIRECTORY);
