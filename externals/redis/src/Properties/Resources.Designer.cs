...
namespace Zongsoft.Externals.Redis.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   查找类似 The &apos;{0}&apos; Redis connection setting does not exist or its driver does not match Redis. 的本地化字符串。
        /// </summary>
        internal static string Redis_ConnectionSettingInvalid_Message {
            get {
                return ResourceManager.GetString("Redis.ConnectionSettingInvalid.Message", resourceCulture);
            }
        }
