...
{
	public class ListenerStartCommand : CommandBase<CommandContext>
	{
		#region 构造函数
		public ListenerStartCommand() : base("Start")
		{
		}

		public ListenerStartCommand(string name) : base(name)
		{
		}
		#endregion
		...
		protected override object OnExecute(CommandContext context)
		{
			...
			{
				context.Output.WriteLine(Properties.Resources.Text_ServerHasBeenStarted);
				return false;
			}
