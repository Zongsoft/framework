...
partial class RSACommand
{
	...
	public class ImportCommand : CommandBase<CommandContext>
	{
		...
		#region 构造函数
		public ImportCommand() : base("Import") { }
		public ImportCommand(string name) : base(name) { }
		#endregion
