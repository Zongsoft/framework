...
partial class SequenceCommand
{
	...
	public class DecreaseCommand : CommandBase<CommandContext>
	{
		...
		static async ValueTask<ConcurrentBag<long>> DecreaseAsync(ICommandOutlet output, ISequenceBase sequence, string key, int interval, int seed, int round, TimeSpan jitter, bool quiet, CancellationToken cancellation)
		{
