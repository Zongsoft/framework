...
public class BuilderManager
{
	...
	private IBuilder GetBuilder(Builtin builtin)
	{
		...
		if(builder == null)
			throw new PluginException(string.Format(Properties.Resources.Plugin_BuilderNotFound_Message, builtin.Scheme, builtin.Plugin.Name, builtin.Plugin.FilePath, Environment.NewLine));
