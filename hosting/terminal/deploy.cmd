...
SET Project_4_Name=Zongsoft.Net
SET Project_4_Destination=zongsoft\net\

SET Project_5_Name=Zongsoft.Scheduling
SET Project_5_Destination=zongsoft\scheduling\

SET Project_6_Name=Zongsoft.Scheduling.Cron
SET Project_6_Path=Zongsoft.Scheduling
SET Project_6_Directory=cron
SET Project_6_Destination=zongsoft\scheduling\cron\

SET Project_7_Name=Zongsoft.Externals.Aliyun
SET Project_7_Path=externals\aliyun
SET Project_7_Destination=zongsoft\%Project_7_Path%\

SET Project_8_Name=Zongsoft.Externals.Redis
SET Project_8_Path=externals\redis
SET Project_8_Destination=zongsoft\%Project_8_Path%\

SET Project_9_Name=Zongsoft.Data.MsSql
SET Project_9_Path=Zongsoft.Data
SET Project_9_Directory=drivers\mssql
SET Project_9_Destination=zongsoft\data\%Project_9_Directory%\

SET Project_10_Name=Zongsoft.Data.MySql
SET Project_10_Path=Zongsoft.Data
SET Project_10_Directory=drivers\mysql
SET Project_10_Destination=zongsoft\data\%Project_10_Directory%\
