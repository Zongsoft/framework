...
public class ExecuteTest(DatabaseFixture database) : IDisposable
{
	...
	public async Task ExecuteAsync()
	{
		...
		var command = Mapping.Commands.Script(DuckDBDriver.NAME, DataCommandMutability.Insert, script)
		...
		command = Mapping.Commands.Script(DuckDBDriver.NAME, script)
			.Parameter("@Severity", DataType.Byte)
		...
		command = Mapping.Commands.Script(DuckDBDriver.NAME, "SELECT * FROM \"Log\"");
