...
public class DuckDBUpdateStatementVisitor : UpdateStatementVisitor
{
	#region 单例字段
	public static readonly DuckDBUpdateStatementVisitor Instance = new();
	#endregion

	#region 构造函数
	private DuckDBUpdateStatementVisitor() { }
	#endregion
