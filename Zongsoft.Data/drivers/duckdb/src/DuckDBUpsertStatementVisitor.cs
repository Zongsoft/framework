...
public class DuckDBUpsertStatementVisitor : UpsertStatementVisitor
{
	#region 单例字段
	public static readonly DuckDBUpsertStatementVisitor Instance = new();
	#endregion

	#region 构造函数
	private DuckDBUpsertStatementVisitor() { }
	#endregion
