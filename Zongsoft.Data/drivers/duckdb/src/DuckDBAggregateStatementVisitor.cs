...
public class DuckDBAggregateStatementVisitor : AggregateStatementVisitor
{
	#region 单例字段
	public static readonly DuckDBAggregateStatementVisitor Instance = new();
	#endregion

	#region 构造函数
	private DuckDBAggregateStatementVisitor() { }
	#endregion
}
