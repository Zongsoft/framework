...
public class DuckDBInsertStatementVisitor : InsertStatementVisitor
{
	#region 单例字段
	public static readonly DuckDBInsertStatementVisitor Instance = new();
	#endregion

	#region 构造函数
	private DuckDBInsertStatementVisitor() { }
	#endregion
