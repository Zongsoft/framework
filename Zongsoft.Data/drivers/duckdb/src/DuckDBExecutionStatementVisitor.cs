...
public class DuckDBExecutionStatementVisitor : ExecutionStatementVisitor
{
	#region 单例字段
	public static readonly DuckDBExecutionStatementVisitor Instance = new();
	#endregion

	#region 构造函数
	private DuckDBExecutionStatementVisitor() { }
	#endregion
}
