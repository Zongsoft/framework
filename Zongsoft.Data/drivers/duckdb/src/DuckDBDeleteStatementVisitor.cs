...
public class DuckDBDeleteStatementVisitor : DeleteStatementVisitor
{
	#region 单例字段
	public static readonly DuckDBDeleteStatementVisitor Instance = new();
	#endregion

	#region 构造函数
	private DuckDBDeleteStatementVisitor() { }
	#endregion
}
