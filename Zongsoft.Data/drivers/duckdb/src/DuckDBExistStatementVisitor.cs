...
public class DuckDBExistStatementVisitor : ExistStatementVisitor
{
	#region 单例字段
	public static readonly DuckDBExistStatementVisitor Instance = new();
	#endregion

	#region 构造函数
	private DuckDBExistStatementVisitor() { }
	#endregion
