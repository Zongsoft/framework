...
public class ExecuteTest(DatabaseFixture database) : IDisposable
{
	...
	public async Task ExecuteAsync()
	{
		...
		var command = Mapping.Commands.Script(PostgreSqlDriver.NAME, DataCommandMutability.Insert, script)
		...
		command = Mapping.Commands.Script(PostgreSqlDriver.NAME, script)
			.Parameter("@Severity", DataType.Byte)
		...
		command = Mapping.Commands.Script(PostgreSqlDriver.NAME, "SELECT * FROM \"Log\"");
