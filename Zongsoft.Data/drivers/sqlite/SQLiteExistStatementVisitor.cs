...
{
	public class SQLiteExistStatementVisitor : ExistStatementVisitor
	{
		#region 单例字段
		public static readonly SQLiteExistStatementVisitor Instance = new SQLiteExistStatementVisitor();
		#endregion

		#region 构造函数
		private SQLiteExistStatementVisitor() { }
		#endregion
