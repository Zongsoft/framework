...
{
	public class SQLiteSelectStatementVisitor : SelectStatementVisitor
	{
		#region 单例字段
		public static readonly SQLiteSelectStatementVisitor Instance = new SQLiteSelectStatementVisitor();
		#endregion

		#region 构造函数
		private SQLiteSelectStatementVisitor() { }
		#endregion
