...
namespace Zongsoft.Data.SQLite
{
	public class SQLiteExpressionVisitor : ExpressionVisitorBase
	{
		...
		{
			#region 单例字段
			public static readonly SQLiteExpressionDialect Instance = new SQLiteExpressionDialect();
			#endregion
		...
		{
			#region 单例字段
			public static readonly SQLiteTableDefinitionVisitor Instance = new SQLiteTableDefinitionVisitor();
			#endregion
