...
{
	public class InfluxExecutionStatementVisitor : ExecutionStatementVisitor
	{
		#region 单例字段
		public static readonly InfluxExecutionStatementVisitor Instance = new();
		#endregion

		#region 私有构造
		private InfluxExecutionStatementVisitor() { }
		#endregion
	}
}
