...
public sealed class InfluxConnectionSettingsDriver : ConnectionSettingsDriver<InfluxConnectionSettings>
{
	#region 单例字段
	public static readonly InfluxConnectionSettingsDriver Instance = new();
	#endregion

	#region 私有构造
	private InfluxConnectionSettingsDriver() : base(InfluxDriver.NAME) { }
	#endregion
}
