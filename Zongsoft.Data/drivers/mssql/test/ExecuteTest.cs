...
public class ExecuteTest(DatabaseFixture database) : IDisposable
{
	...
	public async Task ExecuteAsync()
	{
		...
		var command = Mapping.Commands.Script(MsSqlDriver.NAME, DataCommandMutability.Insert, script)
		...
		command = Mapping.Commands.Script(MsSqlDriver.NAME, script)
			.Parameter("Severity", DataType.Byte)
		...
		command = Mapping.Commands.Script(MsSqlDriver.NAME, "SELECT * FROM [Log]");
