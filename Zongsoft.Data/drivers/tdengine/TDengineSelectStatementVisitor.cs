...
{
	public class TDengineSelectStatementVisitor : SelectStatementVisitor
	{
		#region 单例字段
		public static readonly TDengineSelectStatementVisitor Instance = new TDengineSelectStatementVisitor();
		#endregion

		#region 构造函数
		private TDengineSelectStatementVisitor() { }
		#endregion
