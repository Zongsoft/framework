...
{
	public class MySqlCountStatementVisitor : CountStatementVisitor
	{
		#region 单例字段
		public static readonly MySqlCountStatementVisitor Instance = new MySqlCountStatementVisitor();
		#endregion

		#region 构造函数
		private MySqlCountStatementVisitor()
		{
		}
		#endregion
	}
