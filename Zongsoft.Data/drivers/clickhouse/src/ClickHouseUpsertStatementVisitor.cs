...
{
	public class ClickHouseUpsertStatementVisitor : UpsertStatementVisitor
	{
		#region 单例字段
		public static readonly ClickHouseUpsertStatementVisitor Instance = new ClickHouseUpsertStatementVisitor();
		#endregion

		#region 构造函数
		private ClickHouseUpsertStatementVisitor() { }
		#endregion
