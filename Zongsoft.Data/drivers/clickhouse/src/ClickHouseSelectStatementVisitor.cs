...
{
	public class ClickHouseSelectStatementVisitor : SelectStatementVisitor
	{
		#region 单例字段
		public static readonly ClickHouseSelectStatementVisitor Instance = new ClickHouseSelectStatementVisitor();
		#endregion

		#region 构造函数
		private ClickHouseSelectStatementVisitor() { }
		#endregion
