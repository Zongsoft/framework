...
{
	public class ClickHouseExecutionStatementVisitor : ExecutionStatementVisitor
	{
		#region 单例字段
		public static readonly ClickHouseExecutionStatementVisitor Instance = new ClickHouseExecutionStatementVisitor();
		#endregion

		#region 构造函数
		private ClickHouseExecutionStatementVisitor() { }
		#endregion
	}
}
