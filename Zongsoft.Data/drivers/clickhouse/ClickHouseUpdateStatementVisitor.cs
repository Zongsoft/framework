...
{
	public class ClickHouseUpdateStatementVisitor : UpdateStatementVisitor
	{
		#region 单例字段
		public static readonly ClickHouseUpdateStatementVisitor Instance = new ClickHouseUpdateStatementVisitor();
		#endregion

		#region 构造函数
		private ClickHouseUpdateStatementVisitor() { }
		#endregion
