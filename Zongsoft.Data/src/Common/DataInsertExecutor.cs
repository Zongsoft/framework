				...
				foreach(var field in statement.Fields)
				{
					if(field.Token.Property.IsSimplex)
					{
						...
						if(sequence != null && sequence.IsExternal)
						{
							...
							if((context.Options is IDataInsertOptions options && options.SequenceForced) || value == null || Convert.IsDBNull(value) || object.Equals(value, Zongsoft.Common.TypeExtension.GetDefaultValue(field.Token.MemberType)))
