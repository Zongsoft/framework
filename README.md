...
This is a collection of open source projects for the _**Z**ongsoft_ development framework, supporting _**.NET**_ `8`,`9`,`10` and other versions.
...
- [_**Z**ongsoft.**D**ata_](Zongsoft.Data) [![NuGet Version](https://img.shields.io/nuget/v/Zongsoft.Data)](https://nuget.org/packages/Zongsoft.Data)
	...
	> _**SQL**ite_ Driver
	> - [_duckdb_](Zongsoft.Data/drivers/duckdb/) [![NuGet Version](https://img.shields.io/nuget/v/Zongsoft.Data.DuckDB)](https://nuget.org/packages/Zongsoft.Data.DuckDB)
	> _**D**uckDB_ Driver
